...
{
   v_result = 10.01*sqrt(pow(goal_x - x0, 2) + pow(goal_y - y0, 2)) + 0.01*atan2(-sin(theta0 - (goal_y - y0)/(goal_x - x0)), cos(theta0 - (goal_y - y0)/(goal_x - x0)));
   w_result = 10.02*atan2(-sin(theta0 - (goal_y - y0)/(goal_x - x0)), cos(theta0 - (goal_y - y0)/(goal_x - x0)));
